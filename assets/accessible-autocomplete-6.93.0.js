(function (factory) {
			    ...
			    var t = {
			        ...
			        9724: function (t, e, n) {
			          ...
			          i(b, d, "Iterator Helper"), t.exports = function (t, e) {
			            var n = function (n, r) {
			              r ? (r.iterator = n.iterator, r.next = n.next) : r = n, r.type = e ? v : h, r.nextHandler = t, r.counter = 0, r.done = false, m(this, r);
			            };
	...
	var HMRCAccessibleAutocomplete = /*@__PURE__*/getDefaultExportFromCjs(accessibleAutocomplete_minExports);
