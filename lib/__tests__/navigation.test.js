...
describe('Navigation metalsmith plugin', () => {
  ...
  it('should add an object of unique patterns to metalsmith metadata', (done) => {
    const files = {
      ...
      'section1/zzz/index.html': {
        contents: Buffer.from('test for manually ordering by order field'),
        mode: '0644',
        stats: {},
        filepath: 'section1/zzz/index.njk',
        order: 1
      },
      'section1/aaa/index.html': {
        contents: Buffer.from('another test for manually ordering by order field'),
        mode: '0644',
        stats: {},
        filepath: 'section1/aaa/index.njk',
        order: 2
      },
